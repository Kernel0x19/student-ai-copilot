...
const page = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-[#08090E] text-gray-900 dark:text-[#F0F4FF] transition-colors duration-500">
      <Navbar isAuth={true} />
      <section className="max-w-300 mx-auto px-10 pt-35 pb-16 grid grid-cols-1 lg:grid-cols-2 gap-25 items-center">
        ...
        <div className="flex flex-col gap-8 p-8 shadow-xl border border-black/10 dark:border-white/8 bg-gray-50 dark:bg-[#0F1117] overflow-hidden transition-all duration-500">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <a className="text-xs text-profit flex items-center gap-0.5 hover:underline cursor-pointer group transition-colors duration-500 text-[#0C65D2]">
                Forgot Password?
                <ArrowUpRight
                  size={12}
